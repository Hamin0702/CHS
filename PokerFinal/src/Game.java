...
public class Game extends FlexiblePictureExplorer implements ImageObserver{
	...
	private String[][] images = { {"table","blue_back", "play","bet","stop"},
								  {"AH", "AS", "AC", "AD"},
								  {"2H", "2S", "2C", "2D"},
								  {"3H", "3S", "3C", "3D"},
								  {"4H", "4S", "4C", "4D"},
	...
	public void displayGame() {
		...
		graphics.drawImage(play.getBufferedImage(), 850,60, this);
		graphics.drawImage(bet.getBufferedImage(), 1000,60, this);
		graphics.drawImage(stop.getBufferedImage(), 1150,60, this);
		setImage(disp);
	}
	...
	public void winner() {
		boolean playerWin,compWin = false;
		if(check) {
			System.out.println("---------------------------------------------------");
			HandEvaluator forComp = new HandEvaluator(compCards, tableCards);
